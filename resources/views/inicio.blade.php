    ...
    <main class="home-page">
        ...
        <section class="hero-section">
            <div class="hero-container">
                <div class="hero-content">
                    <h2 class="hero-title">Bem-vindo a Beth Cientista!</h2>
                    <p class="hero-subtitle">Divulgação científica feita por jovens, para jovens</p>
                    <div class="search-wrapper">
                        <div class="search-box">
                            <i class="fa-solid fa-magnifying-glass"></i>
                            <input type="text" id="searchInput" placeholder="Buscar conteúdos incríveis..." autocomplete="off">
                        </div>
                    </div>
                </div>
        ...
        <section class="categories-section">
            <div class="content-container">
                <h3 class="section-title"><span>Escolha sua Aventura!</span></h3>
        ...
        <section class="posts-section">
            <div class="content-container">
                        ...
                        <article class="post-card" data-category="{{ $post->categoria }}" data-date="{{ \Carbon\Carbon::parse($post->created_at)->format('Y-m-d') }}">
                            ...
                            <div class="post-content">
                                ...
                                <div class="post-footer">
                                    <span>Por {{ $post->user->nome ?? $post->aluno->nome ?? $post->autor ?? 'Aluno' }}</span>
                ...
                <div class="no-results" id="noResults" style="display: none;">
                    ...
                    <p>Tente buscar por outra coisa!</p>
                </div>
            </div>
        </section>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function filterPosts() {
                ...
                if (postsTitle) {
                    postsTitle.textContent = selectedCategory === 'Todos' ? 'Todos os Conteúdos' : selectedCategory;
                }
