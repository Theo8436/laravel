...
<head>
  ...
  <style>
    * {
    ...
    /* Estilos das mensagens de erro herdados da tela de login */
    #mensagem {
      text-align: center;
      margin-bottom: 15px;
      font-size: 14px;
...
<body>
  ...
  <div class="cadastro">
    ...
    <p class="subtitulo">Crie sua conta de professor</p>
    ...
    <form action="{{ route('professor.adicionar') }}" method="POST">
      ...
      <div class="campo">
        ...
        <input type="text" id="nome" name="nome" value="{{ old('nome') }}" placeholder="Digite seu nome" required>
      </div>

      <div class="campo">
        <label for="email">Email</label>
        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="seu.email@exemplo.com" required>
      </div>
      ...
      <div class="campo">
        ...
        <input type="text" name="code" id="code" autocomplete="new-password" autocorrect="off" autocapitalize="off" spellcheck="false" placeholder="Digite o código de acesso" required>
      </div>
